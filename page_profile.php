                        ...
                        <div class="row no-gutters row-grid">
                            <div class="col-12">
                                <div class="d-flex flex-column align-items-center justify-content-center p-4">
                                    <img src="img/uploads/<?=$user['image'] ?>" class="rounded-circle shadow-2 img-thumbnail" alt="">
                                    <h5 class="mb-0 fw-700 text-center mt-3">
                                        <?=$user['username'] ?>
                                        <small class="text-muted mb-0"><?=$user['address'] ?></small>
                                    </h5>
                                    <div class="mt-4 text-center demo">
                                        <a href="https://instagram.com/<?=$user['user_social_instagram'] ?>" class="fs-xl" style="color:#C13584">
                                            <i class="fab fa-instagram"></i>
                                        </a>
                                        <a href="https://vk.com/<?= $user['user_social_vk']; ?>" class="fs-xl" style="color:#4680C2">
                                            <i class="fab fa-vk"></i>
                                        </a>
                                        <a href="https://t.me/<?= $user['user_social_telegram']; ?>" class="fs-xl" style="color:#0088cc">
