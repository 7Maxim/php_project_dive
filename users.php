                    ...
                    <div id="c_2" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="alita gray">
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                ...
                                <?php foreach ($status_classes as $key => $value) : ?>

                                    <?php if ($value == $user['status']) : ?>
                                        <span class="status status-<?= $key;?> mr-3">
                                            <span class="rounded-circle profile-image d-block " style="background-image:url('img/uploads/<?= $user['image']; ?>'); background-size: cover;"></span>
                                        </span>
                                    <?php endif; ?>
                                <?php endforeach; ?>

                                <?php if ( $user_logged['role'] === 'admin' || is_author($user_logged['id'], $user['id'])) : ?>
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a href="main/delete_user.php?id=<?= $user['id']; ?>" class="dropdown-item" onclick="return confirm('are you sure?');">
                        ...
                        <div class="card-body p-0 collapse show">
                            <div class="p-3">
                                ...
                                <a class="fs-sm fw-400 mt-4 text-muted">
                                    <i class="fas fa-map-pin mr-2"></i> <?= $user['address']; ?>
                                </a>
                                <div class="d-flex flex-row">
                                    <a href="https://vk.com/<?= $user['user_social_vk']; ?>" class="mr-2 fs-xxl" style="color:#4680C2">
                                        <i class="fab fa-vk"></i>
                                    </a>
                                    <a href="https://t.me/<?= $user['user_social_telegram']; ?>" class="mr-2 fs-xxl" style="color:#38A1F3">
                                        <i class="fab fa-telegram"></i>
                                    </a>
                                    <a href="https://instagram.com/<?= $user['user_social_instagram']; ?>" class="mr-2 fs-xxl" style="color:#E1306C">
