...
<body>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form action="main/media_handler.php?id=<?= $edit_user_id;?>" method="POST" enctype="multipart/form-data">
            <div class="row">
                <div class="col-xl-6">
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                <div class="form-group">
                                    <?php if ( has_image($edit_user_id) ) : ?>
                                        <img src="img/uploads/<?= $edit_user['image'];?>" alt="" class="img-responsive" width="200">
                                    <? else : ?>
                                        <img src="img/uploads/avatar-m.png" alt="" class="img-responsive" width="200">
